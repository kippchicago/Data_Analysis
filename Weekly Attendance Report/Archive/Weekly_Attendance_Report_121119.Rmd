...
DailyEnrollAttend.plotdata<-subset(DailyEnrollAttend.plotdata, 
                                   Date<ymd("2013-06-14")) #Drop last day of school
...
```{r tbl_Weekly_Attendance, dpi=300, out.width=400, fig.width=4, fig.height=12, fig.align='left'}
...
names(WeeklySuspensionsBySchool.table)<-c("Week of", "KAPS", "KAMS", "KCCP",  "Total")
...
names(YTDSuspensionsByGradeBySchool.table)<-c("Grade", "KAPS", "KAMS", "KCCP", "Total")
...
names(YTDSuspensionsByWeekByGrade.table)<-c("Week of", "K", "1st", "2nd", "5th","6th", "7th", "8th", "Total")
...
```{r tbl_Suspensions_Leaderboard, fig.width=11, fig.height=20}
...
```{r tbl_Suspension_most_recent_week, fig.height=12}
