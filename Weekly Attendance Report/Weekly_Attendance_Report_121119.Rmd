...
```{r tbl_Weekly_Attendance, dpi=300, out.width=400, fig.width=4, fig.height=7, fig.align='left'}
...
```{r tbl_Suspensions_Leaderboard, fig.width=11, fig.height=10}
...
```{r tbl_Suspension_most_recent_week, fig.height=4}
Sups.lastweek<-arrange(subset(Suspensions, WeekOfDate>=ymd("2012-12-03"), select=c(CALENDARDATE, GRADE_LEVEL, LASTFIRST, SchoolInitials)),SchoolInitials, GRADE_LEVEL, CALENDARDATE, LASTFIRST)
