...
grid.arrange(leaderboards(AttByStudentBySchool, schoolname="KAPS"),leaderboards(AttByStudentBySchool, schoolname="KAMS"),leaderboards(AttByStudentBySchool, schoolname="KCCP"), ncol=2, nrow=2, heights=unit(10, "inches"))
```
