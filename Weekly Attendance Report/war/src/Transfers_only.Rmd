...
```{r fig_cumulative_transferes, fig.height=7, fig.width=15,  dev='cairo_pdf'}
...
kable(xtable(HSR.attrtions),format='html', table.attr='class="table table-responsive table-hover table-condensed table-striped"', output=TRUE,  row.names=FALSE)
```
