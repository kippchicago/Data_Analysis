...
tntp_file <- "data/Spring 2017 KIPP Chicago_Teacher Survey School Sorter.xlsx"
...
first_foundation_row <- grep("Insight Report", column_A$X__1) + 2
note_row<-grep("Note", column_A$X__1)
last_school_row <- note_row - 2
last_foundation_row <- grep("^School$", column_A$X__1) - 1
...
tntp_s17 <- bind_rows(tntp_schools, tntp_foundation)
