...
tntp_file <- "data/Spring 2018_KIPP Chicago_Teacher Survey School Sorter.xlsx"
...
first_foundation_row <- grep("Insight Report|School Sorter|School Summary", column_A$X__1) + 2
...
tntp_s18 <- bind_rows(tntp_schools, tntp_foundation)
