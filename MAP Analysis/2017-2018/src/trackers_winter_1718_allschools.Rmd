---
title: "Winter 2017-2018 MAP Trackers""
...
nwea<-nwea %>% select(-ClassName, -TeacherName) %>% 
...
cdf_k <- separate_cdf(map_fall_kinder %>% mutate(TestStartTime = as.character(TestStartTime)), "KIPP Chicago")
