---
title: "Fall 2019-2020 MAP Trackers"
...
pull_terms <- list("Spring 2018-2019")
  #get_nwea(table_name = "MAP$comprehensive#plus_cps")
nwea_2 <-pull_terms %>%
  map_df(~ {nwea %>% 
              filter(term_name == .x) %>%
...
growth_df <- map_mv$growth_df %>% as.data.frame() %>%
...
Update school names
```{r school_names}
school_names <- data.frame(schoolid=c(78102, 7810, 4001462, 400146, 4001632, 400163, 4001802, 400180),
